...
Credits to SpinningUp for most of the code.
"""
import json
import joblib
import numpy as np
    ...
    def dump_tabular(self):
        ...
        if proc_id() == 0:
            ...
            for k, v in zip(self.log_headers, vals):
                env_steps = int(self.log_current_row.get('TotalEnvInteracts', ""))
...
class EpochLogger(Logger):
    ...
    def __init__(self, *args, **kwargs):
        ...
        f = open(osp.join(self.output_dir, 'hash.txt'), "a")
        f.write(str(get_hashes()))
        f.close()
