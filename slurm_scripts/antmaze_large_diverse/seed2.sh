...
#SBATCH --job-name=sfp_antmaze_large_seed2
...
python main.py --exp_name antmaze_large_2 --env antmaze-large-diverse-v1 --log_output_dir /share/data/speech/Data/dyunis/exps/wandb/sfp/logs/antmaze_large --seed 2
