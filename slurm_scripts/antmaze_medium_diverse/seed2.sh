...
#SBATCH --job-name=sfp_antmaze_medium_seed2
...
python main.py --exp_name antmaze_medium_2 --env antmaze-medium-diverse-v1 --log_output_dir /share/data/speech/Data/dyunis/exps/wandb/sfp/logs/antmaze_medium --seed 2
