...
#SBATCH --job-name=sfp_kitchen_seed1
...
python main.py --exp_name kitchen_1 --env kitchen-mixed-v0 --log_output_dir /share/data/speech/Data/dyunis/exps/wandb/sfp/logs/kitchen --epochs 400 --seed 1
